		...
		<div className="min-h-screen w-full flex flex-col bg-blue-50 overflow-x-hidden">
			...
			<div className="fixed top-0 left-0 right-0 z-30 w-full bg-blue-900 shadow-lg">
				<div className={cn(
					...
					<Header title="Upload do plano de trabalho" />
				</div>
			</div>
			...
			<div className={cn(
				...
				<main className="p-6 space-y-6 w-full">
					<div className="flex flex-wrap items-start justify-between gap-4 border-b border-slate-200 pb-6">
						<div>
							<p className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-400">Base do projeto</p>
							<h1 className="mt-2 text-[32px] font-semibold tracking-tight text-slate-900">Upload do plano de trabalho</h1>
							<p className="mt-1 text-sm text-slate-500">Envie o plano aprovado para que o LINCE identifique rubricas, metas e limites.</p>
						</div>
						<div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full border border-gray-200 shadow-sm">
							<div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" />
							<span className="text-xs font-semibold text-gray-600">Projeto atual: <span className="text-gray-900">Programa Energia do Futuro</span></span>
						</div>
					</div>
					...
					<div className="grid gap-6 lg:grid-cols-[minmax(0,1.95fr)_minmax(320px,1fr)]">
						<div className="space-y-6">
							<section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
								<div className="mb-6">
									...
									<p className="text-sm text-gray-500 mt-3">O documento será usado como referência para cruzar todas as despesas do projeto.</p>
								</div>

								<div className="border-2 border-dashed border-slate-200 bg-slate-50/80 rounded-[22px] p-12 text-center hover:bg-slate-50 transition-colors cursor-pointer group min-h-[214px] flex items-center justify-center">
									<div>
										<div className="w-16 h-16 bg-emerald-50 rounded-full flex items-center justify-center mx-auto mb-4 ring-1 ring-emerald-100 group-hover:scale-110 transition-transform">
											<CloudUpload className="text-emerald-600 w-8 h-8" />
										</div>
										<p className="text-slate-900 font-semibold text-lg">Arraste o plano para cá</p>
										<p className="text-xs text-slate-500 mt-2">PDF, DOCX ou XLSX até 10 MB</p>
									</div>
								</div>
							</section>
						...
						<div className="space-y-6">
							<section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
								<h3 className="text-lg font-bold mb-2 text-slate-900">Dados identificados</h3>
								<p className="text-sm text-gray-500 mb-6">Resumo extraído do plano vigente</p>
							...
							<section className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
								<h3 className="text-lg font-bold mb-6 text-slate-900">Rubricas e limites</h3>
